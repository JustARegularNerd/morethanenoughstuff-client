...
public class WorldGenUnderwater extends WorldGenerator
{
    ...
    public WorldGenUnderwater(int i, int j, int k)
    {
        underwaterBlockId = i;
        additionalBlockId = j;
        numberOfBlocks = k;
                    ...
                    for(int i3 = i2; i3 <= j2; i3++)
                    {
                        ...
                        if(j3 == Block.sand.blockID)
                        {
                        	if(random.nextInt(10) < 9) {
                        		world.setBlock(k2, l2, i3, underwaterBlockId);
                        	} else {
                        		world.setBlock(k2, l2, i3, additionalBlockId);
                        	}
                        }
                    }
    ...
    private int underwaterBlockId;
    private int additionalBlockId;
